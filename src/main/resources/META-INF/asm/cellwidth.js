...
function initializeCoreMod() {
    ...
    return {
        ...
        'extendclass': {
            'target': {
                'type': 'CLASS',
                'name': 'tamaized.frostfell.world.FrostfellChunkGenerator$CorrectedNoiseSettings'
            },
            'transformer': function (/*org.objectweb.asm.tree.ClassNode*/ classNode) {
        ...
        'superctor': {
            'target': {
                'type': 'METHOD',
                'class': 'tamaized.frostfell.world.FrostfellChunkGenerator$CorrectedNoiseSettings',
                'methodName': '<init>',
        ...
        'fix': {
            'target': {
                'type': 'METHOD',
                'class': 'tamaized.frostfell.world.FrostfellChunkGenerator',
            ...
            'transformer': function (/*org.objectweb.asm.tree.MethodNode*/ methodNode) {
                ...
                instructions.set(
                    ...
                    new TypeInsnNode(
                        Opcodes.NEW,
                        'tamaized/frostfell/world/FrostfellChunkGenerator$CorrectedNoiseSettings'
                        )
                    );
                instructions.set(
